...
// 레이어 리스트 초기화
/**
 * 승인된 레이어 목록으로 사용되는 jQuery UI Sortable과 Selectable을 초기화 한다.
 * @author yijun.so
 * @date 2016. 02
 */
