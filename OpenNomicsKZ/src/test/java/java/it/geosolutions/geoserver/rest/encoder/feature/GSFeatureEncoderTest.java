 ...
 */
package java.it.geosolutions.geoserver.rest.encoder.feature;
...
import java.it.geosolutions.geoserver.rest.GeoserverRESTTest;
import java.math.BigDecimal;
import java.util.List;

import opennomics.geosolutions.geoserver.rest.GeoServerRESTPublisher;
...
import opennomics.geosolutions.geoserver.rest.decoder.about.GSVersionDecoder.VERSION;
import opennomics.geosolutions.geoserver.rest.encoder.GSLayerEncoder;
import opennomics.geosolutions.geoserver.rest.encoder.GSLayerEncoder21;
import opennomics.geosolutions.geoserver.rest.encoder.GSResourceEncoder;
import opennomics.geosolutions.geoserver.rest.encoder.authorityurl.GSAuthorityURLInfoEncoder;
import opennomics.geosolutions.geoserver.rest.encoder.feature.FeatureTypeAttribute;
import opennomics.geosolutions.geoserver.rest.encoder.feature.GSAttributeEncoder;
import opennomics.geosolutions.geoserver.rest.encoder.feature.GSFeatureTypeEncoder;
import opennomics.geosolutions.geoserver.rest.encoder.identifier.GSIdentifierInfoEncoder;
import opennomics.geosolutions.geoserver.rest.encoder.metadata.GSDimensionInfoEncoder;
import opennomics.geosolutions.geoserver.rest.encoder.metadata.GSDimensionInfoEncoder.Presentation;
import opennomics.geosolutions.geoserver.rest.encoder.metadata.GSFeatureDimensionInfoEncoder;
import opennomics.geosolutions.geoserver.rest.encoder.metadata.virtualtable.GSVirtualTableEncoder;
import opennomics.geosolutions.geoserver.rest.encoder.metadata.virtualtable.VTGeometryEncoder;
import opennomics.geosolutions.geoserver.rest.encoder.metadata.virtualtable.VTParameterEncoder;
import opennomics.geosolutions.geoserver.rest.encoder.metadatalink.GSMetadataLinkInfoEncoder;
import opennomics.geosolutions.geoserver.rest.encoder.utils.ElementUtils;
