...
public class ReceiptServiceImpl implements ReceiptService {
	...
	public List<ReceiptVO> selectReceiptList(String stts, int pageNum) throws Exception{
		...
		else if(stts.equals(EnRequestType.INSPECTION_WAITING.getTypeName())){
			infoMap.put("stts", EnRequestType.INSPECTION_WAITING.getstts());
			infoMap.put("pageNum", pageNum);
			list = receiptMapper.selectReceiptList(infoMap);
		}
		else if(stts.equals(EnRequestType.PENDING_APPROVAL.getTypeName())){
			infoMap.put("stts", EnRequestType.PENDING_APPROVAL.getstts());
			infoMap.put("pageNum", pageNum);
			list = receiptMapper.selectReceiptList(infoMap);
		}
		else
	...
	@Transactional
	public void approvalRequest(UserVO user, int rid, String tname, Map<String, String> attInfo,JSONObject layer, List<Map<String, Object>> errList) throws Exception{
		boolean flag = false;
