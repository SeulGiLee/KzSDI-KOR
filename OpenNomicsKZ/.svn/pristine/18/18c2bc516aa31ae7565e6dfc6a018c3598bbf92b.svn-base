...
import opennomics.geosolutions.geoserver.rest.encoder.metadata.virtualtable.VTGeometry;
import opennomics.geosolutions.geoserver.rest.encoder.metadata.virtualtable.VTGeometryEncoder;
import opennomics.geosolutions.geoserver.rest.encoder.metadata.virtualtable.VTParameter;
